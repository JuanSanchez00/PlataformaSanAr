<?php
	...
	if ($resultado) {
		echo "<script> alert('El cliente se elimino correctamente.');  window.location='EmpleadoListaClientes.php?empleado=$empleado'; </script>";
	}
	else {
		echo "<script> alert('Ocurrió un error al eliminar el cliente.');  window.location='EmpleadoListaClientes.php?empleado=$empleado'; </script>";
	}
?>